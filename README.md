# BuildSubmarines — Training Programs Prototype
...
- `educators.html` — Education / Resources for Educators redesign, gated by a login lightbox (login: anything, password: $ubs); assets in `educators-assets/`
